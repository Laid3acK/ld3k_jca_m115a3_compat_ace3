...
class CfgWeapons
{
    ...
    class JCA_srifle_AWM_base_F: Rifle_Long_Base_F
    {
        ...
        initSpeed=-1; // 906, 896 m/s according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25 hPa, 0%)
        magazines[]=
        {
            "JCA_5Rnd_338LM_AWM_Mag",
            "JCA_5Rnd_338LM_AWM_Tracer_Red_Mag",
    ...
    class JCA_muzzle_snds_AWM_black: JCA_muzzle_snds_AWM_base // Sound Suppressor .338, muzzle_snds_338_black
    {
        class ItemInfo: ItemInfo
        {
            ...
            class MuzzleCoef
            {
                ...
                fireLightCoef=0.1;
                recoilCoef=0.95; // muzzle_snds_338_black 1
                recoilProneCoef=0.95; // muzzle_snds_338_black 1
                minRangeCoef=1;
